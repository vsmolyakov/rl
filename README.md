...
- [eps-greedy-bandit](./epsilon_greedy_bandit.py): epsilon greedy k-armed bandit  
...
- [sarsa-lambda](./sarsa_lambda.py): sarsa lambda with replacing eligibility traces for the mountain car  
